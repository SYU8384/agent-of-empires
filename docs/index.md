...
Claude Code, OpenCode, Mistral Vibe, Codex CLI, Kimi CLI, Gemini CLI, Cursor CLI, Copilot CLI, Pi, Factory Droid, Hermes, Kiro CLI, and Qwen Code. AoE auto-detects which are installed.
